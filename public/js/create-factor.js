...
function setParam() {
    ...
    if (d !== "0") {
        ...
        total_debt = parseInt(debt) + parseInt(total_price);
        ...
        document.getElementById("total_debt").value = null;
        document.getElementById("exist_price").value = null;
    }
}
...
function addProduct() {
    ...
    if (product_name) {
        if (isNumber(weight) && isNumber(count) && isNumber(fee)){
            ...
            total_price = total_price + weight * count * fee;
            ...
            total_debt = total_debt + weight * count * fee
            document.getElementById("total_debt").value = addCommas(total_debt)
            document.getElementById("exist_price").value = addCommas(total_debt)
